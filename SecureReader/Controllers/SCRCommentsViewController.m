...
- (void) populateComments {
    ...
    JSQMessage *message = [[JSQMessage alloc] initWithSenderId:@"self" senderDisplayName:@"Self" date:[NSDate date] text:@"test outgoing"];
    JSQMessage *message2 = [[JSQMessage alloc] initWithSenderId:@"other" senderDisplayName:@"Joe Commenter" date:[NSDate date] text:@"test incoming"];
    [self.comments addObject:message];
    [self.comments addObject:message2];
}
